...
class AbstractAnalyzer:
    ...
    def analyze_abstract(self, abstract: str, abstract_number: int, model_type, hf_token = None) -> Dict:
            """
    ...
    def analyze_abstract_in_batches(self, abstract: str, abstract_number: int, model_type, hf_token = None) -> Dict:
        """
